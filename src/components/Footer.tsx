export default function Footer() {
  return (
    <footer className="bg-gray-50 py-16 px-6">
      <div className="max-w-[780px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
      ...
      <div className="max-w-[780px] mx-auto mt-12 pt-8 border-t border-gray-200">
