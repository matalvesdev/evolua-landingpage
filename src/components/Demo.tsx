...
export default function Demo() {
  ...
  return (
    <section
      className="py-24 section-fade"
      id="demo-section"
    >
      <div className="mb-16 text-center px-6 max-w-[960px] mx-auto">
      ...
      <div
        className="relative mx-auto max-w-[960px] px-6"
      ...
      <div className="mt-12 flex justify-end max-w-[960px] mx-auto px-6">
        <a
          href="#social-proof"
