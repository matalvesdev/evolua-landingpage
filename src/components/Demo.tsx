...
export default function Demo() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Main image */}
        <div className="relative bg-gray-50 rounded-2xl shadow-2xl shadow-primary/20 border border-gray-200 overflow-hidden aspect-[4/3] flex items-center justify-center">
          <Image
